...
a clasic example of asymptomatic normality is $N \thicksim  (\mu , \sigma^2)| CI(\mu)_{1-\alpha}=\bar{x}\pm Z_{\frac{\alpha}{2}}*\sqrt{V(\hat\beta)}$
...
have 95% chance of 0.00556 and 00662 and $\beta = 1$ is not between into the coefficient
